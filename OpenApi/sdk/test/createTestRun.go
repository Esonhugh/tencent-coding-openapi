...
func (req *CreateTestRunReq) SetAction() string {
	req.Action = "CreateTestRun"
	return req.Action
}
...
func (t *TestClient) CreateTestRun(req CreateTestRunReq) (resp CreateTestRunResp, err error) {
	err = t.Call(&req, &resp)
	return
}
