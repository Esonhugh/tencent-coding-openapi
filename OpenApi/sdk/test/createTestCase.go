...
func (req *CreateTestCaseReq) SetAction() string {
	req.Action = "CreateTestCase"
	return req.Action
}
...
func (t *TestClient) CreateTestCase(req CreateTestCaseReq) (resp CreateTestCaseResp, err error) {
	err = t.Call(&req, &resp)
	return
}
