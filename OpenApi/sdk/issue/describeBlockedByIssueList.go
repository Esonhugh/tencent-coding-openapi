...
func (req *DescribeBlockedByIssueListReq) SetAction() string {
	return "DescribeBlockedByIssueList"
}
...
func (i *IssueClient) DescribeBlockedByIssueList(req DescribeBlockedByIssueListReq) (resp DescribeBlockedByIssueListResp, err error) {
	err = i.Call(&req, &resp)
	return
}
