...
func (req *DescribeProjectMergeRequestsReq) SetAction() string {
	req.Action = "DescribeProjectMergeRequests"
	return req.Action
}
...
func (m *MergeReqClient) DescribeProjectMergeRequests(req DescribeProjectMergeRequestsReq) (resp DescribeProjectMergeRequestsResp, err error) {
	err = m.Call(&req, &resp)
	return
}
