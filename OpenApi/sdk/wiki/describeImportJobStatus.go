...
func (req *DescribeImportJobStatusReq) SetAction() string {
	req.Action = "DescribeImportJobStatus"
	return req.Action
}
...
func (w *WikiClient) DescribeImportJobStatus(req DescribeImportJobStatusReq) (resp DescribeImportJobStatusResp, err error) {
	err = w.Call(&req, &resp)
	return
}
