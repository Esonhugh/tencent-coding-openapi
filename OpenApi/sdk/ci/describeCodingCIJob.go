...
type DescribeCodingCIJobResp struct {
	Response struct {
		Job struct {
...
func (req *DescribeCodingCIJobReq) SetAction() string {
	req.Action = "DescribeCodingCIJob"
	return req.Action
}

// DescribeCodingCIJob 获取构建计划详情
func (c *CiClient) DescribeCodingCIJob(req DescribeCodingCIJobReq) (resp DescribeCodingCIJobResp, err error) {
	err = c.Call(&req, &resp)
	return
}
